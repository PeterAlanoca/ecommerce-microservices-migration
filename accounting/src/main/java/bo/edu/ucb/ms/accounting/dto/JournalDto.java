...
public class JournalDto {
    ...
    @Pattern(regexp = "D|C", message = "Balance type must be D (Debit) or C (Credit)")
    ...
    @Pattern(regexp = "draft|posted|reversed", message = "Status must be draft, posted, or reversed")
